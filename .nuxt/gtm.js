...
function gtmServer(ctx, initialized) {
  ...
  ctx.beforeNuxtRender(() => {
    ...
    const renderIframe = id => `<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PX32XQD?id=${id}&" height="0" width="0" style="display:none;visibility:hidden" title="gtm"></iframe>`
    if (inits.length) {
